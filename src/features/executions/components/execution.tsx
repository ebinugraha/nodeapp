...
export const ExecutionView = ({ executionId }: { executionId: string }) => {
  ...
  const [showStackTrace, setShowTrackTrace] = useState(false);
        ...
        {execution.error && (
          <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3">
            ...
            {execution.errorStack && (
              <Collapsible
                open={showStackTrace}
                onOpenChange={setShowTrackTrace}
              >
                ...
                <CollapsibleContent>
                  <pre className="text-xs font-mono text-red-900 overflow-auto mt-2 pt-2 bg-red-100 rounded">
                    {execution.errorStack}
                  </pre>
                </CollapsibleContent>
              </Collapsible>
